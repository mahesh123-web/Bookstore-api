...
from generated import bookstore_pb2 as bookstore__pb2
...
class BookstoreServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListBooks = channel.unary_unary(
                ...
                response_deserializer=bookstore__pb2.BookListResponse.FromString,
                _registered_method=True)
...
def add_BookstoreServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListBooks': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=bookstore__pb2.BookListResponse.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'BookstoreService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('BookstoreService', rpc_method_handlers)
...
class BookstoreService(object):
    ...
    def ListBooks(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            bookstore__pb2.BookListResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
